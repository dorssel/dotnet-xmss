...
[TestClass]
sealed unsafe class CriticalXmssKeyGenerationContextHandleTests
{
    static XmssKeyGenerationContext* CreateKeyGenerationContextPointer(ref XmssKeyContext* keyContext)
    {
